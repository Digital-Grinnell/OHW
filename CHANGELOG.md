...
- **Function 1 now accepts MP4 input**: Function 1 can now use `.mp4` sources the same way as `.m4a` sources by preserving the original source file in the output directory and creating `dg_<epoch>.mp3` from it. ([#app.py](app.py), [#FUNCTION_1_WAV_TO_MP3.md](FUNCTION_1_WAV_TO_MP3.md), [#README.md](README.md), [#FUNCTION_5_REPORT_PROGRESS.md](FUNCTION_5_REPORT_PROGRESS.md))
...
#### Core Functions
- **Function 1: Convert WAV/M4A/MP4 to MP3** - High-quality audio conversion using FFmpeg
